...
public class NumberLevelSelectButton : MonoBehaviour
{
    [Header("Level Data")]
    [SerializeField] private NumberModuleData gameData;
    ...
    public void OnButtonClick()
    {
        if (gameData == null)
        {
            Debug.LogError("Number Module Data is not assigned!");
            return;
        }
    ...
    public void SetLevelData(NumberModuleData data)
    {
        gameData = data;
    }
